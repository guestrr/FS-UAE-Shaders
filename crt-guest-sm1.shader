...
#define bloom 0.70         // bloom strength 
...
#define beam_min 1.25      // Scanline dark pixels
...
#define cubic 1.0          // 'Cubic filtering'  0.0 - 1.0  (use 1.0 for full effect)
#define mask 0.0           // CRT Mask (3&4 are 4k masks) 0.0 - 4.0
#define maskmode 1.0       // CRT Mask Mode: Classic, Fine, Coarse  0.0 - 2.0
#define maskdark 1.00      // CRT Mask Strength Dark Pixels  0.0 - 1.50
